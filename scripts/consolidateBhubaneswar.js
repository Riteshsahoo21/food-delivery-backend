...
const bhubaneswarRestaurants = [
  {
    vendorEmail: 'dfnokh2@gmail.com',
    vendorName: 'Ritesh (Ritzs Kitchen)',
    vendorPhone: '+91 94370 12345',
    restaurant: {
      name: 'Ritzs Food Lounge & Biryani',
      slug: 'ritzs-food-lounge-biryani',
      image: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=800&auto=format&fit=crop&q=80',
      banner: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1200&auto=format&fit=crop&q=80',
      cuisines: ['Biryani', 'North Indian', 'Odia Specials', 'Tandoor'],
      rating: 4.8,
      ratingCount: '520+',
      ...
      featured: true,
      topRated: true,
      offer: 'FLAT 25% OFF | USE RITZ25',
      address: 'Sai NIVAS, 565/1597, Sabarsahi Ln, Rasulgarh, Bhubaneswar, Odisha 751010',
      coordinates: { lat: 20.2921899, lng: 85.8589983 },
      isOpen: true,
      status: 'APPROVED',
    },
    menuItems: [
      {
        name: 'Special Royal Pakhala Bhata',
        description: 'Chilled fermented rice with curd, roasted cumin, curry leaves, served with Badi Chura, Fried Brinjal, Saga Bhaja, and Aloo Chokha.',
        price: 191,
        discountPrice: 179,
        isVeg: true,
        isBestseller: true,
        ...
        addons: [
          { name: 'Add Fried Fish (Machha Bhaja)', price: 75 },
          { name: 'Extra Badi Chura Bowl', price: 30 },
        ],
      },
      {
        name: 'Rasulgarh Special Chicken Biryani',
        description: 'Fragrant basmati rice dum cooked with juicy marinated chicken pieces, whole spices, saffron, and fried golden onions.',
        price: 260,
        discountPrice: 229,
        isVeg: false,
        isBestseller: true,
        ...
        addons: [
          ...
          { name: 'Burani Garlic Raita', price: 35 },
        ],
      },
      {
        name: 'Tandoori Chicken Full (4 Pcs)',
        description: 'Whole spring chicken marinated in yogurt and special tandoori masala, roasted crisp in charcoal tandoor.',
        price: 360,
        isVeg: false,
        isBestseller: false,
        rating: 4.7,
        ...
        addons: [{ name: 'Mint Chutney & Onions', price: 20 }],
      },
    ],
  },
  {
    ...
    restaurant: {
      ...
      slug: 'the-royal-biryani-kebabs-master-canteen',
    ...
    menuItems: [
      ...
      },
      {
        ...
        addons: [{ name: 'Mint Chutney & Pickled Onions', price: 25 }],
      },
      {
  ...
  },
  {
    ...
    restaurant: {
      ...
      slug: 'odisha-dalma-authentic-odia-thali-saheed-nagar',
  ...
  },
  {
    ...
    restaurant: {
      ...
      slug: 'dakshin-dosa-idli-express-patia',
  ...
  },
  {
    ...
    restaurant: {
      ...
      slug: 'urban-tandoor-grill-garden-khandagiri',
  ...
  },
  {
    ...
    restaurant: {
      ...
      slug: 'dragon-wok-dimsum-lounge-kharvel-nagar',
    ...
    menuItems: [
      ...
      },
      {
        ...
        addons: [{ name: 'Add Fried Egg on Top', price: 25 }],
      },
      {
  ...
  },
  {
    ...
    restaurant: {
      ...
      slug: 'the-crust-patty-burger-co-patia',
  ...
  },
  {
    ...
    restaurant: {
      ...
      slug: 'pahala-rasgulla-mithai-mahalo-old-town',
...
async function run() {
  ...
  const defaultHash = await bcrypt.hash('VendorPass2026!', salt);

  for (const item of bhubaneswarRestaurants) {
    let vendor = await User.findOne({ email: item.vendorEmail });
    if (!vendor) {
      ...
      vendor.password = defaultHash;
      vendor.role = 'vendor';
      await vendor.save();
    }

    let rest = await Restaurant.findOne({ slug: item.restaurant.slug });
    if (!rest) {
      // Check by name
      rest = await Restaurant.findOne({ name: item.restaurant.name });
    }
    ...
    if (!rest) {
      ...
      Object.assign(rest, item.restaurant);
      rest.owner = vendor._id;
      await rest.save();
    }

    // Upsert menu items
    for (const m of item.menuItems) {
      let existing = await MenuItem.findOne({ restaurant: rest._id, name: m.name });
      if (!existing) {
